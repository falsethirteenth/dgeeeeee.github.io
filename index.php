...
<html lang="en-US">
<head>
<title>FALSE HOUSE</title>
<meta charset="utf-8">
<meta name="description" content="Здесь обитает Бог под названием False">
<meta name="keywords" content="FALSE, HOUSE, YouTube, Instagram, Music, Истории, Spotify, Анекдоты, Бог, Spotify, Anime.">
<meta name="google-site-verification" content="cO1o6sx54cvKxhbnYsABWtl4sYFj9uVKV0DxLKZkWv8"/>
<?php include 'lib/module/sys-meta.php';?>
<meta property="og:title" content="Бог - FALSE">
<meta property="og:description" content="Читать истории и рекомендации к фильмам, разного рода темы." />
...
<meta name="twitter:title" content="FALSE HOUSE - Здесь обитает Бог.">
...
<body>
<img src="/img/graphics/landing/1233.png" width="1" height="1" alt="preload"/>
<img src="/img/videos/1500.jpg" width="1" height="1" alt="Preload"/>
<img src="/img/videos/1123.jpg" width="1" height="1" alt="Preload"/>
...
<div class="page-con-content landing-con-override">
		...
		<div class="content-con-outside">
			<div class="content-con-inside">
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx1-heading pulsate'>
							<h1>♛FALSE HOUSE♛<br>
							 Большой дядя пока спит😴</h1>
						</div>
						<div class='landing-tx2-heading'>
							<p>
								 Привет! Меня зовут False и ты попал на бета-версию моего сайта)) 
							</p>
							<div>
								<div>
									<div>
										<div>
											<div>
												<section> <audio src="img/videos/189.mp3" controls autoplay loop></audio> </section>
										</div>
									     </div>
									</div>
								</div>
				...
				<div class='landing-con-right content-remove '>
					<div class='landing-img-hero' style="background: url(/img/graphics/landing/1233.png) no-repeat center; background-size: contain;">
					</div>
				</div>
			</div>
		</div>
	...
	<div class="landing-con-discord darkmode-discord">
		<div class="discord-left-logo">
			<img alt="Discord Left Banner" src="/img/graphics/svg/instagram-left.png" style="width: 100%; height: 100%;">
		</div>
		<div class="discord-center-logo">
			<img alt="Discord Logo" src="/img/graphics/svg/instagram-center.png" style="width: 100%; height: 100%;">
		</div>
		<div class="discord-right-logo">
			<img alt="Discord Right Banner" src="/img/graphics/svg/instagram-right.png" style="width: 100%; height: 100%;">
		</div>
		<div class="content-con-outside">
			<div class="content-con-inside">
					...
					<div class="discord-con-mantra">
						<div class="discord-wrp-mantra scale-content-txt-1">
							...
							<div class="discord-tx2-mantra darkmode-txt">
								<p>
									 С вопросами писать сюда буду рад пообщаться.хых								</p>
							</div>
							<a href="https://www.instagram.com/false.13/" target="_blank">
					...
					<div class="patreon-con-mantra">
						<div class="patreon-wrp-mantra scale-content-txt-1 ">
							...
							<div class="patreon-tx2-mantra darkmode-txt">
								<p>
									 Если вам понравился сайт буду премного благодарен за поддержку💸.
								</p>
							</div>
							<a href="https://send.monobank.ua/jar/7mRyMTN3Gu" target="_blank">

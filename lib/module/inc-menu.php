	...
	<div class='mini-menu-con-container'>
		...
		<div class='mini-menu-tx2-block'>
			<p>
				...
				<br>
				 Purchasing legitimate game copies, through the <u>PlayStation Store</u> or through acquiring game discs, and using those copies with RPCS3 is the best way to ensure you will have a clean copy that will work with the emulator. You can use your <b>legal</b> copies with RPCS3 by following the instructions in our <a href="/Анекдоты" target="_blank">Анекдоты</a> guide.
			</p>
		</div>
...
<div class='menu-con-container'>
	...
	<div class="menu-con-outer">
		<div class="menu-con-inner">
			...
			<a href='https://open.spotify.com/playlist/18xvJSawIXP9dldutnAqgW?si=9Ifo2s9XQW2pwPjSI217kQ&utm_source=copy-link'
				target="blank">
			<div class="menu-btn-select">
				<span>Spotify</span>
			</div>
			...
			<a href="https://www.tiktok.com/@false_react/"
		     target="blank">
			<div class="menu-btn-select">
				<span>TikTok</span>
			</div>
			...
			<a href="https://www.youtube.com/channel/UCPytJIQzbYnITvLtGc0LNFw" target="_blank">
			<div class="menu-btn-select">
				<span>YouTube</span>
			</div>
			</a>
